...
class RegistrationForm(Form):
	...
	password2 = PasswordField('password2', validators=[validators.DataRequired(), validators.EqualTo('password', message='Password and confirm password fields must match')])
